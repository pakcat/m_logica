...
import 'package:m_logica/app/modules/truck/truck_controller.dart';
import 'package:m_logica/app/modules/truck/widget/truck_card.dart';
import 'package:m_logica/app/routes/app_routes.dart';

class TruckScreen extends GetView<TruckController> {
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return InkWell(
                        onTap: () {
                          Get.toNamed(AppRoutes.detailTruck);
                        },
                        child: CardTruck(
